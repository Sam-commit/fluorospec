    ...
    return Padding(
      ...
      child: Container(
        child: LineChart(LineChartData(
                    ...
                    getTooltipItems: (List<LineBarSpot> touchedBarSpots) {
                      return touchedBarSpots.map((barSpot) {
                        ...
                        return LineTooltipItem(
                            "x= " + flSpot.x.toInt().toString()+ " , ",
                            TextStyle(
                                color: Colors.black,
                                fontWeight: FontWeight.normal),
                            children: [
                              TextSpan(
                                text: "y= " + data[flSpot.x.toInt()-401].toString(),
                                style: TextStyle(
                                  color: Colors.black,
                                  fontWeight: FontWeight.normal,
                                ),
            ...
            clipData:
                FlClipData(right: true, top: false, left: false, bottom: false),
            lineBarsData: [
              LineChartBarData(
                //showingIndicators: ,
                ...
                sideTitles: SideTitles(
                    ...
                    getTitlesWidget: (value, name) {
                      switch (value.toInt()) {
                        case 1:
                          return Text((type)
                              ? mini.toStringAsFixed(3)
                              : mini.toStringAsFixed(0));
                        case 2:
                          return Text((type)
                              ? (mini + div).toStringAsFixed(3)
                              : (mini + div).toStringAsFixed(0));
                        case 3:
                          return Text((type)
                              ? (mini + 2 * div).toStringAsFixed(3)
                              : (mini + 2 * div).toStringAsFixed(0));
                        case 4:
                          return Text((type)
                              ? (mini + 3 * div).toStringAsFixed(3)
                              : (mini + 3 * div).toStringAsFixed(0));
                        case 5:
                          return Text((type)
                              ? (mini + 4 * div).toStringAsFixed(3)
                              : (mini + 4 * div).toStringAsFixed(0));
                        case 6:
                          return Text((type)
                              ? (mini + 5 * div).toStringAsFixed(3)
                              : (mini + 5 * div).toStringAsFixed(0));
                        case 7:
                          return Text((type)
                              ? (mini + 6 * div).toStringAsFixed(3)
                              : (mini + 6 * div).toStringAsFixed(0));
                      }
                      return Text("");
                    }),
              ),
